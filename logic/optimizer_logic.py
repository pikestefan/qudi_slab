...
class OptimizerLogicPxScan(GenericLogic):

    """This is the Logic class for optimizing scanner position on bright features. Lazily adapted for the pixel scanner.
    """
