...
###############     Gerneral Methods    ###############
    ...
    def play_any(self, clk_rate, seq_len, laser_times, apd_times=[], apd_ref=[], mw_times=[], method=None, rep=100, mw_pulse=False, trigger=True, neg_mw=False):
        ...
        if method == 'delaysweep':
            ...
            self.play_ramsey(seq_len, laser_times, apd_times, apd_ref, mw_times, rep, trigger)

        elif method == 'rabi':
            # Do Rabi
            # print("It does Rabi.")
            self.play_rabi(seq_len, laser_times, apd_times, apd_ref, mw_times, rep, trigger, neg_mw)
